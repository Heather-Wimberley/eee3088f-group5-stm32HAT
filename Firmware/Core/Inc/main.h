...
#define Proximity_Active_Pin GPIO_PIN_4
#define Proximity_Active_GPIO_Port GPIOB
#define Proximity_Interrupt_Pin GPIO_PIN_5
#define Proximity_Interrupt_GPIO_Port GPIOB
